  90 PRINT "BASIC LIBRARY--'BASEBL'--18-JUL-70"
 220 '  *  *  *  *  *  *  *  MAIN PROGRAM  *  *  *  *  *  *  *  *  *  *
 230 '
 240 RANDOM
 250 FOR I=0 TO 19
 ...
 990 LET T=O2=1
1000 PRINT"THE WORLD SERIES-- FROM ST. LOUIS, MO."
1010 PRINT"QUESTIONS ASKING 'WHICH BASE' SHOULD BE ANSWERED WITH A DIGIT"
1020 PRINT"THOSE ASKING ABOUT ADVANCEMENT OF RUNNERS WILL PRINT"
...
1320 INPUT T$
1330 IF T$="N" THEN 1350
1340 GOTO 5920
1350 IF W1=0 THEN 1380
1360 LET S(B(0),6)=2
1370 LET W1=0
1380 IF W3=T+1 THEN 1410
1390 LET W2=W2+1
1400 GOTO 1420
1410 LET W3=0
...
1510 LET W1=1
1520 IF RND>S(10*(1-T),1) THEN 1570
...
1600 GOSUB 8110
1610 GO TO 1570
1620 IF B(3)=0THEN 1670
1630 PRINT"INFIELD IN";
1640 INPUT T$
1650 IF T$<>"Y" THEN 1670
1660 LET I1=1
...
2400 ON X2/.35+10/7+4*S(B(0),6) GOTO 2410,2410,2440,2470,2470,2470,2440,2410
...
2730 PRINT "DEEP ";
2740 LET F2=3
2750 ON X2/.35+11/7+4*S(B(0),6) GOTO 2760,2760,2790,2820,2820,2820,2790,2760
...
2980 INPUT T$
2990 IF T$="Y" THEN 3030
3000 IF T$="N" THEN 3060
3010 PRINT"CHANCE="C
3020 GOTO 2970
3030 GOSUB 8580
...
3510 GOTO 1170
3520 FOR J=1 TO 29
3530 IF X1<D(J,S(B(0),6)) THEN 3560
3540 NEXT J
3550 LET J=30
...
4160 ON D(J,2) GOTO 4190,4190,4170,4170,4190,4220
4170 LET T7=1
4180 GOTO 4290
4190 LET B(1)=B(2)
4200 LET B(2)=0
...
4230 INPUT T$
4240 IF T$="Y" THEN 4280
4250 IF T$="N" THEN 4190
4260 PRINT"CHANCE=.3 IF HE IS PLAYED"
4270 GOTO 4220
4280 LET B(5)=.7
4290 IF B(3)*(1-B(6))=0 THEN 4560
4300 LET V=D(J,2)+6*I1
4310 ON V GOTO 4320,4320,4440,4560,4440,4560,4320,4320,4320,4540,4320,4540
4320 IF B(2)=0 THEN 4400
4330 IF T7=0 THEN 4370
4340 LETB(1)=B(2)
4350 LET B(2)=0
4360 GOTO 4400
...
4460 INPUT T$
4470 IF T$="Y" THEN 4560
4480 IF T$="N" THEN 4520
...
4610 PRINT"CHANCES FOR OUTS AT EACH BASE"
4620 PRINT"1: AUTOMATIC",
4630 FOR I=2 TO 4
4640 PRINT I":";
...
5670 INPUT T$
5680 IF T$="Y" THEN 5720
5690 IF T$="N" THEN 8160
...
6460 LET T6=I+1
6470 NEXT I
6480 IF L(4)+L(5)+L(6)=1 THEN 6520
6490 PRINT"WHICH BASE DO YOU THROW TO (4=HOME)";
6500 INPUT T6
6510 IF L(T6+2)=0 THEN 6490
6520 LET I=T6-1
6530 IF RND<S(12-10*T,7)THEN 6670
6540 PRINT "ERROR BY THE CATCHER"
6550 IF RND<.5 THEN 6570
6560 LET W6=1
6570 LETD=1
6580 FOR I=3 TO 1 STEP-1
6590     IF L(I+3)=0THEN 6610
6600     GOSUB 8310
6610 NEXT I
6620 IF W6<>1 THEN 6640
6630 GOSUB 8110
6640 IFO1=0THEN 1350
6650 LETO2=O1
6660 GOTO 8160
6670 IFRND<L(I+6) THEN 6720
6680 LET O1=O1+1
6690 PRINT N$(B(I))" OUT STEALING"
6700 LET B(I)=0
6710 IF O=2 THEN 6570
6720 FOR J=3 TO 1 STEP -1
6730 IF J=I THEN 6770
6740 IF L(J+3)<>1 THEN 6770
6750 IF ABS(J-I)>1 THEN 6770
6760 IF L(J)-10*B(J)=4 THEN 6790
6770 NEXT J
6780 GOTO 6570
6790 IF RND<L(J+6)THEN 6570
6800 LET O1=O1+1
6810 PRINT N$(B(J))" OUT STEALING"
6820 LET B(J)=0
6830 GOTO 6570
6840 PRINT
6850 PRINT N$(B(0))" IS UP"
6860 PRINT"INTENTIONAL WALK";
6870 INPUT T$
6880 IF T$="Y"THEN 1680
6890 PRINT"BUNT";
6900 INPUT T$
6910 IF T$<>"Y" THEN 1490
6920 LET P2=0
...
7550 LET B(3)=0
7560 GOTO 4110
7570 IF P0>P3 THEN 7960
7580 PRINT"GOOD SACRIFICE BUNT"
...
8270 IF S(10,8)>S(0,8) THEN 8070
8280 GOTO 1060
...
8450 INPUT T$
8460 IF T$="Y" THEN 8500
8470 IF T$="N" THEN 8540
...
8590 LET D=1
8600 PRINT"DO YOU WANT "N$(16+F-10*T)" TO THROW TO THE PLATE";
8610 INPUT T$
8620 IF T$="Y" THEN 8660
8630 IF T$="N" THEN 8930
8640 PRINT"CHANCE TO SCORE="C
8650 GOTO 8600
8660 PRINT"DO YOU WANT "N$(B(1))" TO BREAK FOR SECOND";
8670 INPUT T$
8680 IF T$="Y" THEN 8730
8690 IF T$="N" THEN 8780
